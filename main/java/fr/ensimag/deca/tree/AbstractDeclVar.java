...
public abstract class AbstractDeclVar extends Tree {
    ...
    protected abstract EnvironmentExp verifyDeclVarPass3(DecacCompiler compiler, EnvironmentExp envExpSup,
                                                         EnvironmentExp envExp, ClassDefinition currentClass)
                                                            throws ContextualError;

    protected abstract void codeGenDeclVarMethodBody(DecacCompiler compiler, String className, String methodName);
}
